...
本目录的界面图标于 2026-09-18 从 [Lucide](https://lucide.dev/icons/) 获取。Lucide 采用 ISC License。

## English

The interface icons in this directory were fetched from the Lucide icon set on 2026-09-18: <https://lucide.dev/icons/>. Lucide is licensed under the ISC License.
